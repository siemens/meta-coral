...
def _impl(ctx):
                ...
                flag_set(
                    ...
                    flag_groups = [
                        flag_group(
                            flags = [
                                "-std=c++11",
                                "-isystem", "%{ARM_COMPILER_PATH}%/aarch64-linux-gnu/include/c++/10",
                                "-isystem", "%{ARM_COMPILER_PATH}%/aarch64-linux-gnu/include/c++/10/backward",
                                "-isystem", "%{ARM_COMPILER_PATH}%/aarch64-linux-gnu/libc/usr/include/",
                                "-isystem", "%{ARM_COMPILER_PATH}%/lib/gcc-cross/aarch64-linux-gnu/10/include",
                                "-isystem", "%{ARM_COMPILER_PATH}%/aarch64-linux-gnu/include",
                                "-isystem", "%{ARM_COMPILER_PATH}%/include/aarch64-linux-gnu",
                                "-isystem", "%{ARM_COMPILER_PATH}%/include",
                            ],
                        ),
                    ],
                ),
                ...
                flag_set(
                    ...
                    flag_groups = [
                        flag_group(
                            flags = [
                                "-std=c++11",
                                "-isystem", "%{AARCH64_COMPILER_PATH}%/aarch64-linux-gnu/include/c++/10",
                                "-isystem", "%{AARCH64_COMPILER_PATH}%/aarch64-linux-gnu/include/c++/10/backward",
                                "-isystem", "%{AARCH64_COMPILER_PATH}%/aarch64-linux-gnu/libc/usr/include/",
                                "-isystem", "%{AARCH64_COMPILER_PATH}%/lib/gcc-cross/aarch64-linux-gnu/10/include",
                                "-isystem", "%{AARCH64_COMPILER_PATH}%/aarch64-linux-gnu/include",
                                "-isystem", "%{AARCH64_COMPILER_PATH}%/include/aarch64-linux-gnu",
                                "-isystem", "%{AARCH64_COMPILER_PATH}%/include",
                            ],
                        ),
                    ],
                ),
    ...
    if (ctx.attr.cpu == "armeabi"):
        cxx_builtin_include_directories = [
                "%{ARM_COMPILER_PATH}%/aarch64-linux-gnu/include/c++/10",
                "%{ARM_COMPILER_PATH}%/aarch64-linux-gnu/include/c++/10/aarch64-linux-gnu",
                "%{ARM_COMPILER_PATH}%/aarch64-linux-gnu/include/c++/10/backward",
                "%{ARM_COMPILER_PATH}%/aarch64-linux-gnu/libc/usr/include/",
                "%{ARM_COMPILER_PATH}%/lib/gcc-cross/aarch64-linux-gnu/10/include",
                "%{ARM_COMPILER_PATH}%/aarch64-linux-gnu/include",
                "%{ARM_COMPILER_PATH}%/include/aarch64-linux-gnu",
                "%{ARM_COMPILER_PATH}%/include",
            ]
    elif (ctx.attr.cpu == "aarch64"):
        cxx_builtin_include_directories = [
                "%{AARCH64_COMPILER_PATH}%/aarch64-linux-gnu/include/c++/10",
                "%{AARCH64_COMPILER_PATH}%/aarch64-linux-gnu/include/c++/10/aarch64-linux-gnu",
                "%{AARCH64_COMPILER_PATH}%/aarch64-linux-gnu/include/c++/10/backward",
                "%{AARCH64_COMPILER_PATH}%/aarch64-linux-gnu/libc/usr/include/",
                "%{AARCH64_COMPILER_PATH}%/lib/gcc-cross/aarch64-linux-gnu/10/include",
                "%{AARCH64_COMPILER_PATH}%/aarch64-linux-gnu/include",
                "%{AARCH64_COMPILER_PATH}%/include/aarch64-linux-gnu",
                "%{AARCH64_COMPILER_PATH}%/include",
            ]
    elif (ctx.attr.cpu == "local"):
